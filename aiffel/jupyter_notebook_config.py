...
c.NotebookApp.tornado_settings = { 'headers': { 'Content-Security-Policy': "frame-ancestors 'self' http://localhost:3000 localhost:3000 https://dev.lms.aiffel.io/ https://stg.lms.aiffel.io/ https://lms.aiffel.io" } }
